...
/***/ (function(module, exports, __webpack_require__) {
	...
	var NumericInput = function (_Component) {
	    ...
	    _createClass(NumericInput, [{
	        ...
	        value: function _step(n, callback) {
	            ...
	            var baseValue = this.state.value;
	            var _n = this._toNumber((baseValue || 0) + step * n, false);
	        ...
	        value: function render() {
	            ...
	            var _props = this.props,
	                ...
	                truncateRange = _props.truncateRange,
	                rest = _objectWithoutProperties(_props, ['step', 'min', 'max', 'precision', 'parse', 'format', 'mobile', 'value', 'type', 'style', 'defaultValue', 'onInvalid', 'onValid', 'truncateRange']);
	...
	NumericInput.propTypes = {
	    ...
	    truncateRange: _propTypes2.default.bool,
